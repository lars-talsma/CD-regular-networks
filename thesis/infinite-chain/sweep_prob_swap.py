...
def run_simulation(params):
    ...
    number_of_nodes = 2*max_swap_dist+1
    time = 200000
    test = False

    prob_swap = params 
    
    virtual_link_age_array, virtual_node_degree, virtual_neighbourhood_size, swap_count, link_fail_count = skeleton.simulation_infinite_chain(prob_succ_gen, prob_succ_swap, prob_swap, time_cutoff, qubits_per_node, time, max_swap_dist, number_of_nodes, test)
