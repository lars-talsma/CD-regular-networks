...
sim_time = 25*time_cutoff
qubits_per_node = 3*time_cutoff  # Represents an infinite memory for an infinite honeycomb lattice
...
results = [virtual_neighbourhood_size_mean, virtual_neighbourhood_size_std_error,
            virtual_node_degree_mean, virtual_node_degree_std_error]

end = timer()
print(time_cutoff, prob_swap, end - start)

np.save('data/data_inf_honeycomb_conv_oscil', results)