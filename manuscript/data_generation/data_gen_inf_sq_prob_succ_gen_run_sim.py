...
def run_simulation(params):
    ...
    time_cutoff = int(np.floor(11/prob_succ_gen)) # Normalize cutoff time 
    number_of_nodes = 2*(max_swap_dist+1)+1
    sim_time = 3*time_cutoff
    qubits_per_node = 4*time_cutoff  # Represents an infinite memory for an infinite square lattice
    ...
    print(prob_succ_gen, time_cutoff, prob_swap, end - start)
