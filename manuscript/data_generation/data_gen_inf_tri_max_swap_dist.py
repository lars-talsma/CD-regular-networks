...
import numpy as np
import data_gen_inf_tri_max_swap_dist_run_sim
...
if __name__ == '__main__':
    ...
    results = pool.map(data_gen_inf_tri_max_swap_dist_run_sim.run_simulation, params, chunksize=1)

end = timer()
print(end - start) # Time in seconds

np.save('data/data_inf_tri_max_swap_dist', results)