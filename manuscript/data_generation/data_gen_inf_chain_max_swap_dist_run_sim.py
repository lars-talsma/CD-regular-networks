...
def run_simulation(params):
    ...
    qubits_per_node = 2*time_cutoff  # Represents an infinite memory for an infinite square lattice
    ...
    for n in range(N_sample):
        (virtual_link_age_array, virtual_node_degree, virtual_neighbourhood_size, swap_count, link_fail_count) = (
            skeleton_inf_chain.simulation_infinite_chain(prob_succ_gen, prob_succ_swap, prob_swap, time_cutoff, 
